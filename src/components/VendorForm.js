...
const downloadQR = () => {
  ...
  downloadLink.download = `${data[0].description}.png`;
    ...
    <>
      ...
      >
        <div style={{ textAlign: "center", marginTop: 10 }}>
          {console.log("QRRcode", qrcode)}
          <QRCode id="123456" size={500} value={`${qrcode}`} />
          <br />
      <input
        type="button"
      ...
      />
      <br />
      <a href="http://localhost:5001">Notify Distributor</a>
